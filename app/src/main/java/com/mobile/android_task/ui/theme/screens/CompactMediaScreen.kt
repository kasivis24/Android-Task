...
@Composable
fun CompactMediaScreen(navController: NavController, folderId : String, folderName : String, fileViewModel: FileViewModel = viewModel(), viewModel: NetworkViewModel = hiltViewModel(), mediaGalleryViewModel: MediaGalleryViewModel, folderViewModel: FolderViewModel = viewModel()){
    ...
    var itemSelected by remember { mutableStateOf(-1) }
    ...
    val viewFileData = remember { mutableStateOf(FileData(0,"","","","","","","","")) }

    val orientation = LocalConfiguration.current

    var viewChange by remember { mutableStateOf(false) }
...
//                            Text(
//                                modifier = Modifier.padding(vertical = 5.dp),
//                                text = "File Name --> ${viewFileData.value.fileName}",
//                                fontSize = 14.sp,
...
//                            Text(
//                                modifier = Modifier.padding(vertical = 5.dp),
//                                text = "File Type --> ${viewFileData.value.fileType}",
//                                fontSize = 14.sp,
//                                fontWeight = FontWeight.W600,
//                                fontFamily = gilroy
//                            )
...
//                            Text(
//                                modifier = Modifier.padding(vertical = 5.dp),
//                                text = "Upload Date --> ${viewFileData.value.createdDate}",
//                                fontSize = 14.sp,
//                                fontWeight = FontWeight.W600,
//                                fontFamily = gilroy
//                            )
...
//                            Text(
//                                modifier = Modifier.padding(vertical = 5.dp),
//                                text = "Upload Time --> ${viewFileData.value.uploadedTime}",
//                                fontSize = 14.sp,
//                                fontWeight = FontWeight.W600,
//                                fontFamily = gilroy
//                            )
...
//                            Text(
//                                modifier = Modifier.padding(vertical = 5.dp),
//                                text = "File Size --> ${viewFileData.value.fileSize}",
//                                fontSize = 14.sp,
//                                fontWeight = FontWeight.W600,
//                                fontFamily = gilroy
//                            )
...
//
//
//                        if (viewFileData.value.determineFileType() == FileType.VIDEO){
//                            VideoPlayerScreen(viewFileData.value.fileUrl)
//                        }
//
//                        else{
//                            AsyncImage(
...
//                                    .data("${viewFileData.value.fileUrl}")
//                                    .crossfade(true)
